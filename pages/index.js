  ...
  return (
    ...
    <Grommet theme={grommet}>
      ...
      >
        ...
        <Paragraph responsive={true} size="large" margin="none">
          I’ve delivered multiple successful projects, using the agile software
          development process, that are used by thousands of people every day.
          With my customer-centric skillset, I create valuable relationships
          with my clients and development team.
        </Paragraph>
      </Box>
      <Box
        direction="column"
      ...
      >
        ...
        <Box>
          ...
          <Paragraph responsive={true} size="large">
            ...
            product. I worked with a team of developers and designers to create
            an improved, modern experience based on user and stakeholder
            feedback.
          </Paragraph>
        </Box>
      </Box>
