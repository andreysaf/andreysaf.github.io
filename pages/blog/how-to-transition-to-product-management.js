  ...
  return (
    <Layout>
      <Head>
        ...
        <link
          rel='canonical'
          href='https://andreysafonov.com/blog/how-to-transition-to-product-management'
        />
        <meta
          name='Description'
      ...
      <Container maxW={'7xl'} p='12'>
        <VStack paddingTop='40px' spacing='2' alignItems='flex-start'>
          ...
          <Text as='p' fontSize='lg'>
            ...
            , we have discussed the role of a technical solution engineer as
            well as different career paths one can take to become one. In this
          ...
          <Text as='p' fontSize='lg'>
            ...
            adjusting and extending existing features to make the product work
            for their must-haves and nice-to-haves.
          </Text>
          <Text as='p' fontSize='lg'>
            ...
            prospects, customers, and end-users. Your main focus is ensuring
            that the product with all of its features is solving user pain.
          </Text>
          <Heading as='h4' size='sm' pt={5}>
            Calls and meetings
          </Heading>
          ...
          <Text as='p' fontSize='lg'>
            ...
            focus groups, user experience testing, and customer connects. This
            is in addition to internal meetings. It is important to have a
          ...
          <Text as='p' fontSize='lg'>
            ...
            intaking the feedback from several data sources and applying various
            prioritization techniques to get the buy-in from all the
          ...
          <Text as='p' fontSize='lg'>
            ...
            could be that some of the APIs are missing, written poorly, are not
            compatible with their use case, or that there are limitations with
            the infrastructure or framework that they are deploying your
            solution on. After the PoC is completed, the prospect will test with
            their users. Users will quickly spot what works well, what does not,
            and whether or not the UI makes sense and provides a great user
            experience for their use case. During this time, it is important to
            capture as much information as possible about the product's gaps,
            limitations, and use cases and drive the feedback back to the teams.
          </Text>
          <Heading as='h4' size='sm' pt={5}>
          ...
          <Text as='p' fontSize='lg'>
            ...
            ensure you comply with all laws and regulations. You are creating
            sales enablement materials and providing training to solution
            engineers and sales.
          </Text>
          <Heading as='h4' size='sm' pt={5}>
            Performance
          ...
          <Text as='p' fontSize='lg'>
            ...
            Using the OKR framework, it becomes easy to track your performance
            and see if you are successful in meeting your key results.
          </Text>
          <Heading as='h3' size='md' pt={5}>
          ...
          <Text as='p' fontSize='lg'>
            ...
            however, it is best to mock up the design and get the actual user to
            try it out. This feedback should help prototype quicker.
          </Text>
          <Heading as='h4' size='sm' pt={5}>
            Product Marketing
          </Heading>
          <Text as='p' fontSize='lg'>
            ...
            why behind the feature and what pain it is solving. Come up with a
            unique value proposition that differentiates you from the
